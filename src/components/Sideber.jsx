...
const Sideber = () => {
    return (
        <div className="hidden w-64 bg-gray-800 md:block min-h-screen">
        ...
        <nav className="text-sm text-gray-300">
          <ul className="flex flex-col">
            ...
            <li className="px-4 cursor-pointer hover:bg-gray-700">
              <Link className="py-3 flex items-center" to="/dashboard/addskills">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <li className="px-4 cursor-pointer hover:bg-gray-700">
              <Link className="py-3 flex items-center" to="/dashboard/addblog">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <li className="px-4 cursor-pointer hover:bg-gray-700">
              <Link className="py-3 flex items-center" to="/dashboard/addexperience">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
