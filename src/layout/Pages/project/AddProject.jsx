...
const AddProject = () => {
  ...
  const [selectedFeatures, setSelectedFeatures] = useState([]); // State for managing selected features
  ...
  const handleLogin = async (e) => {
    ...
    mutate(
      { name, features: selectedFeatures, client, server, live, description, photo: uploads[0] },
      {
        onSuccess: () => {
      ...
      <div className="border my-8 rounded">
        <form onSubmit={handleLogin} className="card-body">
          <div className="form-control">
            ...
            <input type="text" name="name" placeholder="Enter Project Name" className="input input-bordered" required />
          </div>
          <div className="form-control">
          ...
          <div className="form-control">
            ...
            <input type="text" name="client" placeholder="Enter Git Client" className="input input-bordered" />
          </div>
          <div className="form-control">
            <label className="label">
              <span className="label-text">Git Server</span>
            </label>
            <input type="text" name="server" placeholder="Enter Git Server" className="input input-bordered" />
          </div>
          <div className="form-control">
            <label className="label">
              <span className="label-text">Live Link</span>
            </label>
            <input type="text" name="live" placeholder="Enter Live Link" className="input input-bordered" />
          </div>
